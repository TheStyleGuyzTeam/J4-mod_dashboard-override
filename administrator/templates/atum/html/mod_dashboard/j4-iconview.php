 ...
 * 3) select "Advanced" > "Layout" "j4-iconview" in mod_dashboard
 * (optionlly, re-order the module to a preferred position in the list)
 *
 * override locations:
 ...
 *
 * @RussW (hotmango & thestyleguyz) : 8-October-2021
 */
...
JHtml::_('stylesheet', 'administrator/templates/'. $app->getTemplate() .'/html/mod_dashboard/css/j4-iconview.css');
